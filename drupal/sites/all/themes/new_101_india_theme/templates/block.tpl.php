...
<?php 
$class = "";
if($block->delta == 'series-block_1'){
	$class = "latest-101";
}elseif ($block->delta == 'series-block_2') {
	$class = "most-popular";
}elseif ($block->delta == 'series-block_3') {
	$class = "must-watch";
}
?>
<div class="block-title <?php echo $class; ?>"><?php print $title?></div>
<?php if(!empty($block->subject)){ ?>
	<hr class="hr-<?php echo $class; ?>" />	
<?php } ?>
<?php print $content ?>