...
<div class="dataContainer">
    ...
    <?php /* ?><div class="metaDate"><span><?php print $fields['published_at']->content; ?></span></div><?php */ ?>
...
<?php /* ?><div class="yellowBg">
	...
	<div class="toRight">
		<ul class="followOpts">
			...
			<li class="social">
				<a href="https://www.youtube.com/channel/UCZwZrym87YpirLIFBzTnWQA" target="_blank"><img src="<?php echo $image_url;?>youtube-circle.png"></a>
			</li>
			<li class="social">
				<a href="https://www.facebook.com/101India" target="_blank"><img src="<?php echo $image_url;?>fb-circle.png"></a>
			</li>
			<li class="social">
				<a href="https://twitter.com/101India" target="_blank"><img src="<?php echo $image_url;?>tw-circle.png"></a>
			</li>
			<!--<li class="social">
				<a href="https://plus.google.com/+101India/posts" target="_blank"><img src="<?php //echo $image_url;?>gplus-circle.png"></a>
			</li>-->
			
			<li class="social">
				<a href="http://i.instagram.com/101india/" target="_blank"><img src="<?php echo $image_url;?>insta-circle.png"></a>
			</li>
			<!--<li class="social">
				<a href="<?php //echo $base_url; ?>/rss-feed.xml" target="_blank"><img src="<?php //echo $image_url;?>rss-circle.png"></a>
			</li>-->
