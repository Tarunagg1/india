...
<footer>
	<div class="page">
        <div class="footerContent">
            <ul>
                <li style="border:none;"><a href="https://www.offbeet.in" target="_blank"><img src="https://www.offbeet.in/wp-content/themes/engitech-child/assets/images/logo/OFFBEET_LOGO_FIN.svg" alt="Offbeet Media" style="height:50px; width: 50px;"></a> &copy; Offbeet Media & Communications LLP</li>
                <li><a href="<?php echo $base_url; ?>/about-us">ABOUT US</a></li>
                <li><a href="<?php echo $base_url; ?>/contact-us">CONTACT US</a></li>
                <li><a href="<?php echo $base_url; ?>/terms-and-conditions">TERMS</a></li>
                <li><a href="<?php echo $base_url; ?>/privacy-policy">PRIVACY</a></li>
                <?php /*<li><a href="javascript:;">NEWSLETTER</a></li>*/ ?>
