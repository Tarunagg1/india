    ...
    <div class="articleContent">
        <div class="lhsContent">
            ...
            <div class="articleSummary">
                ...
                <?php /* ?><div class="metaDate"><?php echo date('F j, Y',$content['field_essay']['#object']->published_at);?></div><?php */ ?>
            ...
            <div class="articleSummary">
            <?php if(isset($content['field_essay'])){ ?>
                <ul>
                <?php
                ...
                ?>
                    <li>
                        <?php if(isset($val['field_essay_title']['und']) && !empty($val['field_essay_title']['und'])){ ?>
                        <h3>
                            <?php echo strip_tags($val['field_essay_title']['und'][0]['value']); ?>
                        </h3>
                        <?php } ?>

                        <?php if(isset($val['field_listicle_body']['und']) && !empty($val['field_listicle_body']['und'])){
                            echo '<p>' . $val['field_listicle_body']['und'][0]['value'] . '</p>';
                        } ?>
                        
                        <?php if(isset($val['field_image']['und']) && !empty($val['field_image']['und'])){
                            $imagePath = image_style_url('listicle_photoessay',$val['field_image']['und'][0]['uri']);
                            $imgAlt = !empty($val['field_image']['und'][0]['alt'])?$val['field_image']['und'][0]['alt']:$title;
                            $imgTtl = !empty($val['field_image']['und'][0]['title'])?$val['field_image']['und'][0]['title']:$title;
                        ?>
                            <img src="<?php echo $imagePath; ?>" alt="<?php echo $imgAlt; ?>" title="<?php echo $imgTtl; ?>" />
                        <?php } ?>
