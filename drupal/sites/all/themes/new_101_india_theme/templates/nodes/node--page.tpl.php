...
$currPageUrl = drupal_get_path_alias();

$mainClass = '';

if($currPageUrl == 'about-us'){
    $mainClass = 'aboutContent';
}else if($currPageUrl == 'contact-us'){
    $mainClass = 'contactContent';
}else if($currPageUrl == 'privacy-policy' || $currPageUrl == 'terms-and-conditions'){
    $mainClass = 'privacyPolicy';
}
?>

<div class="pageBanner staticPages">
	<div class="pgTitle"><h1><?php echo $title;?></h1></div>
