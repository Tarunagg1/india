...
//drupal_add_js($base_url . '/' . drupal_get_path('theme', 'new_101_india_theme') . '/scripts/lib/oauth.js');
//drupal_add_js($base_url . '/' . drupal_get_path('theme', 'new_101_india_theme') . '/scripts/require.js');
