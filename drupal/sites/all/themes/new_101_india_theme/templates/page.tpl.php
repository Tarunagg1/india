...
<div class="page <?php echo $bgClass; ?>">
    ...
    <div class="containerwrap">
        ...
        <div class="contentWrap contentSlide">            
            ...
            <?php if ($path_args == 'node/75'): ?>
                <div class="footer-banner" style="display: none;"><?php
                    echo views_embed_view('header_banner', 'block'); ?>
                </div>
            <?php endif; ?>
            <div class="footer-banner"><?php
                echo views_embed_view('header_banner', 'block'); ?>
            </div>
