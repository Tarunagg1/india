...
function adaptivetheme_subtheme_preprocess_image(&$variables) {
  foreach (array('width', 'height') as $key) {
    unset($variables[$key]);
  }
}

function adaptivetheme_subtheme_form_simple_subscription_form_alter(&$form, &$form_state, &$form_id){
    ...
    $form['#submit'][] = 'adaptivetheme_subtheme_simple_subscribe_after_submit';
}

function adaptivetheme_subtheme_simple_subscribe_after_submit(){
