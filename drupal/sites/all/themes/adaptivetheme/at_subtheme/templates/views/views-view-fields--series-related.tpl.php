	...
	<div class="description">
	    ...
	    <div class="mediaIconHolder">
	        <div class="mediaIcon video">
	        	<img src="<?php echo $contentTypeImage; ?>" />
	        </div>
	        ...
	        <span><?php print $fields['created']->content; echo (isset($fields['field_article_category']) && !empty($fields['field_article_category'])?' | '.$fields['field_article_category']->content.'':''); ?></span>
	        <div class="clear"></div>
	    </div>
	</div>
</div>