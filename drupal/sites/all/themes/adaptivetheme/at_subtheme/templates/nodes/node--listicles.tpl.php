...
//echo '<pre style="display: none">';print_r($content['flippy_pager']);echo '</pre>';
			...
			<div class="content">
				...
				<div class="postContent">
                    ...
                    ?>
                        ...
                        if(isset($val['field_soundcloud_embed']['und']) && !empty($val['field_soundcloud_embed']['und'])){
                            ...
                            if (preg_match('/show_artwork=(true|false)/', $souncloudIframe)) {
                                $souncloudIframe = preg_replace('/show_artwork=(true|false)/', 'show_artwork=false' , $souncloudIframe);
                            }else {
                                $souncloudIframe = preg_replace('/">/', '&show_artwork=false">', $souncloudIframe);
                            }
