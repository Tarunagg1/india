...
<div class="page">
    <div class="fixedPanel">
		<div class="menuBtnWrap">
			...
			<?php endif; ?>
			<div class="mobileMenuBtn"><a id="menu-toggle" class="menu-toggle" href="javascript:;"></a></div>
		</div>
		
		<?php unset($page['sidebar_first']['system_navigation']);
        unset($page['sidebar_first']['system_main-menu']);
        
        $sidebar_first = render($page['sidebar_first']); print $sidebar_first; ?>
	</div>

    <?php /*<!-- !Leaderboard Region -->
